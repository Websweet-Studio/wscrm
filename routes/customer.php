...
Route::prefix('customer')->name('customer.')->group(function () {
    Route::get('hosting', fn () => redirect('/hosting'));
    Route::get('hosting/{any}', fn () => redirect('/hosting'))->where('any', '.*');

    Route::get('domains/search', fn () => redirect('/domains/search'));
    Route::get('domains', fn () => redirect('/domains'));
