...
class AiDefaultSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Rate kredit per 1M token ≈ margin ±2.5x harga pasar /1M (kurs Rp18.000) ÷ Rp5.000.
        $models = [
            ['model_key' => 'openai/gpt-4o-mini', 'display_name' => 'GPT-4o Mini', 'input_rate' => 1500, 'output_rate' => 5500, 'sort_order' => 1],
            ['model_key' => 'openai/gpt-4o', 'display_name' => 'GPT-4o', 'input_rate' => 25000, 'output_rate' => 90000, 'sort_order' => 2],
            ['model_key' => 'anthropic/claude-3.5-sonnet', 'display_name' => 'Claude 3.5 Sonnet', 'input_rate' => 27000, 'output_rate' => 135000, 'sort_order' => 3],
        ];
