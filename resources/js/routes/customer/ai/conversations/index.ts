...
/**
* @see \App\Http\Controllers\Customer\AiController::show
 * @see app/Http/Controllers/Customer/AiController.php:80
 * @route '/customer/ai/conversations/{conversation}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: '/customer/ai/conversations/{conversation}',
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\Customer\AiController::destroy
 * @see app/Http/Controllers/Customer/AiController.php:90
 * @route '/customer/ai/conversations/{conversation}'
 */
