...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="w-full max-w-none space-y-4 sm:space-y-6">
            <!-- Header -->
            <div>
                <h1 class="text-2xl font-bold tracking-tight sm:text-3xl">Tambah Karyawan Baru</h1>
                <p class="text-sm text-muted-foreground sm:text-base">Daftarkan karyawan internal baru</p>
            </div>
