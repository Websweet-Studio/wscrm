                        ...
                        <div v-if="settings.image?.length" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div v-for="setting in settings.image" :key="setting.key" class="space-y-4">
                                    ...
                                    <div v-if="imagePreviews[setting.key]" class="space-y-3">
                                        <div class="relative h-32 w-32 overflow-hidden rounded-lg border-2 border-blue-300 dark:border-blue-600">
                                            <img
                                            ...
                                            <div class="absolute top-1 right-1">
                                                <button
                                                    ...
                                                    class="flex h-6 w-6 items-center justify-center rounded-full bg-red-500 text-xs text-white hover:bg-red-600"
                                                >
                                                    ×
                                                </button>
                                            </div>
