      ...
      <div class="mx-auto max-w-4xl sm:px-6 lg:px-8 space-y-6">
          ...
          <CardContent>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p :class="isOverdue ? 'text-red-600 font-semibold' : ''">{{ formatDate(invoice.due_date) }}</p>
              </div>
            </div>
        ...
        <Card v-if="!showConfirmation">
          <CardHeader>
            ...
            <CardDescription>
              Pilih bank dan metode pembayaran yang Anda inginkan
            </CardDescription>
          </CardHeader>
            ...
            <form @submit.prevent="submitPayment">
              ...
              <div class="space-y-3">
                ...
                <select 
                  ...
                  id="bank_id"
                  class="flex h-10 w-full rounded-md border border-input bg-background dark:bg-gray-800 px-3 py-2 text-sm text-foreground dark:text-white ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                >
              ...
              <Card v-if="selectedBank" class="bg-muted/50">
                ...
                <CardContent class="space-y-2">
                  ...
                  <div v-if="selectedBank.admin_fee > 0" class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded p-3">
          ...
          <CardContent class="space-y-6">
            ...
            <div v-if="selectedBank" class="space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                  <label class="text-sm font-medium text-muted-foreground">Kode Bank</label>
                  <p class="text-lg font-mono">{{ selectedBank.bank_code }}</p>
                </div>
                <div class="space-y-2">
                  <label class="text-sm font-medium text-muted-foreground">No. Rekening</label>
                  <p class="text-xl font-mono font-bold text-primary">{{ selectedBank.account_number }}</p>
                </div>
                <div class="space-y-2">
                  <label class="text-sm font-medium text-muted-foreground">Nama Rekening</label>
