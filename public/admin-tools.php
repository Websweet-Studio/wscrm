    ...
    'database' => [
        ...
        'actions' => [
            ...
            'migrate_optimize' => [
                ...
                'description' => 'Run migrations then rebuild caches (optimize)',
                'variant' => 'success',
                'commands' => [
            ...
            'db_seed_users' => [
                ...
                'variant' => 'success',
                'commands' => ['php artisan db:seed --class=Database\\Seeders\\SuperAdminSeeder --force --no-interaction'],
            ],
            'db_seed_domain' => [
                'label' => 'Seed Domain Prices',
                'description' => 'Seed data harga domain',
                'variant' => 'success',
                'commands' => ['php artisan db:seed --class=Database\\Seeders\\DomainPriceSeeder --force --no-interaction'],
            ],
            'db_seed_layanan' => [
                'label' => 'Seed Service Plans',
                'description' => 'Seed data paket layanan',
                'variant' => 'success',
                'commands' => ['php artisan db:seed --class=Database\\Seeders\\ServicePlanSeeder --force --no-interaction'],
            ],
            'db_seed_hosting' => [
            ...
            'migrate_fresh' => [
                ...
                'variant' => 'destructive',
                'commands' => ['php artisan migrate:fresh --force --no-interaction'],
